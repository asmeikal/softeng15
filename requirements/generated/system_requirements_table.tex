...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_APPBID\_F\_M\_5}$ & Funzionale & Media
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
...
\subsubsection{\code{REQ\_F\_6} - Verifica Saldo}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_VERSAL\_F\_A\_6}$ & Funzionale & Alta
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
...
\subsubsection{\code{REQ\_F\_7} - Verifica Andamento Titoli Azionari}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_VERTIT\_F\_M\_7}$ & Funzionale & Media
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
...
\subsubsection{\code{REQ\_F\_8} - Accesso Account Dipendenti}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_DIPACC\_F\_A\_8}$ & Funzionale & Alta
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
...
\subsubsection{\code{REQ\_F\_9} - Verifica Storico}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_VERSTOR\_F\_A\_9}$ & Funzionale & Alta
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
