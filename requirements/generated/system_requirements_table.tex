...
\subsubsection{\code{REQ\_F\_3} - Accesso Clienti}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_CLIACC\_F\_A\_3}$ & Funzionale & Alta
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
...
\subsubsection{\code{REQ\_F\_4} - Creazione Operazioni Veloci}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_CROPVEL\_F\_M\_4}$ & Funzionale & Media
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
...
\subsubsection{\code{REQ\_F\_5} - Disposizione Operazioni Veloci}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_DISOPVEL\_F\_M\_5}$ & Funzionale & Media
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
...
\subsubsection{\code{REQ\_F\_6} - Approvazione cliente pre-registrato}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_APPRCORR\_F\_A\_6}$ & Funzionale & Alta
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
...
\subsubsection{\code{REQ\_F\_7} - Creazione Bidding}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_CREABID\_F\_A\_7}$ & Funzionale & Alta
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
...
\subsubsection{\code{REQ\_F\_9} - Verifica Saldo}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_VERSAL\_F\_A\_9}$ & Funzionale & Alta
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
...
\subsubsection{\code{REQ\_F\_10} - Verifica Andamento Titoli Azionari}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_VERTIT\_F\_M\_10}$ & Funzionale & Media
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
...
\subsubsection{\code{REQ\_F\_11} - Bidding Utente}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_USRBID\_F\_A\_11}$ & Funzionale & Alta
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
...
\subsubsection{\code{REQ\_F\_12} - Accesso Account Dipendenti}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_DIPACC\_F\_A\_12}$ & Funzionale & Alta
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
...
\subsubsection{\code{REQ\_F\_13} - Verifica Storico}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_VERSTOR\_F\_A\_13}$ & Funzionale & Alta
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
