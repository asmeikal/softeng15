...
\subsubsection{\code{REQ\_F\_1} - Verifica Storico}
...
\pcells{
	$\code{REQ\_VERSTOR\_F\_A\_1}$ & Funzionale & Alta
}
\pline
...
\subsubsection{\code{REQ\_F\_2} - Accesso Clienti}
\label{sec:sistema:funzionali:CLIACC}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_CLIACC\_F\_A\_2}$ & Funzionale & Alta
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
		I clienti della banca che abbia adottato HBS devono poter accedere al sistema tramite web browser, utilizzando le credenziali fornite al momento dell'iscrizione.
}
\pline
\ptitlerow{Origine requisito}
\prow{
...
\ptitle{Output}
\pcell{1}{
		Indicatore di successo della procedura di accesso al sistema.
}
\pline
\ptitlerow{Descrizione azione}
\prow{
		Il sistema di HBS verifica le credenziali fornite dall'utente, e permette o rifiuta l'accesso all'utente.
}
%\pline
%\ptitlerow{Pre-condizioni}
%\prow{
...
\subsubsection{\code{REQ\_F\_3} - Approvazione cliente pre-registrato}
\label{sec:sistema:funzionali:APPRCORR}

\begin{ptable}{3}
\ptitlerow{Titolo}
\prow{
		Approvazione cliente pre-registrato
}
\pline
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_APPRCORR\_F\_A\_3}$ & Funzionale & Alta
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
		I dipendenti della banca devono poter approvare o rifiutare la pre-registrazione effettuata da un cliente della banca dopo aver verificato i dati forniti nella procedura di pre-registrazione.
}
\pline
\ptitlerow{Origine requisito}
\prow{
...
\ptitle{Input}
\pcell{1}{
		Un cliente di HBS pre-registrato ma non ancora approvato, e un'azione fra ``approva'' e ``rifiuta''.
}
\pline
\ptitle{Output}
\pcell{1}{
...
\ptitlerow{Descrizione azione}
\prow{
		In caso l'azione sia ``approva'', il cliente pre-registrato viene promosso a cliente registrato. In caso l'azione sia ``rifiuta'', il cliente pre-registrato viene rimosso dal sistema.
}
%\pline
%\ptitlerow{Pre-condizioni}
%\prow{
...
\subsubsection{\code{REQ\_F\_4} - Bidding Utente}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_USRBID\_F\_A\_4}$ & Funzionale & Alta
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
...
\subsubsection{\code{REQ\_F\_5} - Creazione Operazioni Veloci}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_CROPVEL\_F\_M\_5}$ & Funzionale & Media
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
...
\subsubsection{\code{REQ\_F\_7} - Iscrizione Nuovo Correntista}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_ISCRCORR\_F\_A\_7}$ & Funzionale & Alta
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
...
\subsubsection{\code{REQ\_F\_8} - Approvazione Bidding}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_APPBID\_F\_A\_8}$ & Funzionale & Alta
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
...
\subsubsection{\code{REQ\_F\_10} - Creazione Bidding}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_CREABID\_F\_A\_10}$ & Funzionale & Alta
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
...
\subsubsection{\code{REQ\_F\_11} - Disposizione Operazioni Veloci}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_DISOPVEL\_F\_M\_11}$ & Funzionale & Media
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
...
\subsubsection{\code{REQ\_F\_12} - Disposizioni di Pagamento}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_DISPAG\_F\_A\_12}$ & Funzionale & Alta
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
...
\subsubsection{\code{REQ\_F\_13} - Verifica Saldo}
...
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_VERSAL\_F\_A\_13}$ & Funzionale & Alta
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
...
\subsubsection{\code{REQ\_F\_14} - Gestione Privilegi Correntista}
\label{sec:sistema:funzionali:PRIVCORR}

\begin{ptable}{3}
\ptitlerow{Titolo}
\prow{
		Gestione Privilegi Correntista
}
\pline
\pcells{ID & Tipologia & Priorit\`a}
\pcells{
	$\code{REQ\_PRIVCORR\_F\_A\_14}$ & Funzionale & Alta
}
\pline
\ptitlerow{Descrizione requisito}
\prow{
		I dipendenti della banca devono poter gestire i privilegi di lettura e scrittura dei clienti di HBS verso i conti correnti da loro posseduti presso l'istituto.
}
\pline
\ptitlerow{Origine requisito}
\prow{
...
\ptitle{Input}
\pcell{1}{
		Un cliente di HBS, un conto corrente presso l'istituto, e un'azione fra ``rimuovi associazione'', ``fornisci permesso lettura'', ``formisci permesso scrittura''.
}
\pline
\ptitle{Output}
\pcell{1}{
...
\ptitlerow{Descrizione azione}
\prow{
		Se l'azione \`e ``rimuovi associazione'', ogni permesso (di lettura e di scrittura) del cliente fornito sul conto selezionato viene rimosso. Se l'azione \`e ``fornisci permesso lettura'' o ``fornisci permesso scrittura'', il permesso specificato viene fornito al cliente sul conto selezionato.
}
%\pline
%\ptitlerow{Pre-condizioni}
%\prow{
