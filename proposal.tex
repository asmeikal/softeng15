\documentclass[utf8,draft]{softeng}
...
Considerata la necessit\`a crescente di aumentare la trasparenza bancaria e i controlli fiscali automatizzati, il governo ha varato un pacchetto di leggi che impone alle societ\`a di credito italiane di adeguarsi allo standard OBP\footnote{Open Bank Project} gi\`a in vigore in Germania.
...
La nostra applicazione permetter\`a ai clienti della banca di effettuare le normali operazioni bancarie da casa, accedendo al sito della banca tramite web browser.
