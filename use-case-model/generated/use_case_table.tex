...
\subsection{\code{UC\_8} - Titolo }
\label{sec:use-case:MNEMO}

\begin{ptable}{2}
\ptitle{Titolo}
\pcell{1}{
	Titolo (\code{UC\_MNEMO\_8})
}
\pline
\ptitle{Descrizione use case}
\pcell{1}{
...
\subsection{\code{UC\_9} - Iscrizione Correntista }
\label{sec:use-case:ISCRCORR}

\begin{ptable}{2}
\ptitle{Titolo}
\pcell{1}{
	Iscrizione Correntista (\code{UC\_ISCRCORR\_9})
}
\pline
\ptitle{Descrizione use case}
\pcell{1}{
...
\subsection{\code{UC\_10} - Approvazione cliente pre-registrato }
\label{sec:use-case:APPRCORR}

\begin{ptable}{2}
\ptitle{Titolo}
\pcell{1}{
	Approvazione cliente pre-registrato (\code{UC\_APPRCORR\_10})
}
\pline
\ptitle{Descrizione use case}
\pcell{1}{
...
\subsection{\code{UC\_11} - Disposizione Operazione Veloce }
\label{sec:use-case:DISOPVEL}

\begin{ptable}{2}
\ptitle{Titolo}
\pcell{1}{
	Disposizione Operazione Veloce (\code{UC\_DISOPVEL\_11})
}
\pline
\ptitle{Descrizione use case}
\pcell{1}{
...
\subsection{\code{UC\_12} - Titolo }
\label{sec:use-case:MNEMO}

\begin{ptable}{2}
\ptitle{Titolo}
\pcell{1}{
	Titolo (\code{UC\_MNEMO\_12})
}
\pline
\ptitle{Descrizione use case}
\pcell{1}{
