\subsection{\code{UC\_1} - Visualizzazione Bidding }
\label{sec:use-case:BIDVIS}

\begin{ptable}{2}
\ptitle{Titolo}
\pcell{1}{
	Visualizzazione Bidding (\code{UC\_BIDVIS\_1})
}
\pline
...
\subsection{\code{UC\_4} - Disposizione Operazione Veloce }
\label{sec:use-case:DISOPVEL}

\begin{ptable}{2}
\ptitle{Titolo}
\pcell{1}{
	Disposizione Operazione Veloce (\code{UC\_DISOPVEL\_4})
}
\pline
\ptitle{Descrizione use case}
\pcell{1}{
...
\subsection{\code{UC\_5} - Iscrizione Correntista }
\label{sec:use-case:ISCRCORR}

\begin{ptable}{2}
\ptitle{Titolo}
\pcell{1}{
	Iscrizione Correntista (\code{UC\_ISCRCORR\_5})
}
\pline
\ptitle{Descrizione use case}
\pcell{1}{
...
\subsection{\code{UC\_7} - Creazione Operazione Veloce }
\label{sec:use-case:CROPVEL}

\begin{ptable}{2}
\ptitle{Titolo}
\pcell{1}{
	Creazione Operazione Veloce (\code{UC\_CROPVEL\_7})
}
\pline
\ptitle{Descrizione use case}
\pcell{1}{
